  ...
  return (
    <div className="familyContainer">
      ...
      <div className="familyContainer__header">
        <h1 className="familyContainer__header__firstSentence">
          Un lieu de partage et de rencontres pour les parents et les enfants.
        </h1>
        <p className="familyContainer__header__firstParagraph">
          Les activités proposées vous permettent, parents et grands-parents, de partager
          un moment avec vos enfants et petits enfants de 0 à 12 ans : activité manuelle,
          cuisine, motricité, éveil musical, balades, ….
        </p>
      ...
      <div className="familyContainer__workshop">
        ...
        <div className="familyContainer__workshop__hourly">
          <div className="familyContainer__workshop__hourly__hollydaysOff">
            ...
            <p>Lundi, mardi et jeudi : 9h-11h, salle des fêtes de St Quentin de Baron.</p>
          ...
          <div className="familyContainer__workshop__hourly__hollydaysOn">
            ...
            <p>Une fois par mois le samedi de 10h à12h (lieu variable).</p>
          </div>
        </div>
